...
def plot_feature_importance(importance_dict, output_path=None):
    ...
    wedges, texts, autotexts = ax2.pie(pie_importances, labels=pie_features, autopct='%1.1f%%',
...
def save_importance_report(importance_dict, output_path):
    ...
    report = {
        ...
        'sorted_features': [{'feature': f, 'importance': float(imp), 'percentage': float(imp*100)} 
